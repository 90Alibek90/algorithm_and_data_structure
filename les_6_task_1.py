...
def findElem1(array):
    ...
    if max_appearances > 1:
        mem += sys.getsizeof(unique_elems) + sys.getsizeof(max_appearances) + sys.getsizeof(
            appearances) + sys.getsizeof(result) + sys.getsizeof(unique_num) + sys.getsizeof(num)
...
if __name__ == "__main__":
    print(findElem1(array))  # findElem1 - 13320
    print(findElem2(array))  # findElem2 - 27488
    print(findElem3(array))  # findElem3 - 57016

    # Вывод findElem1 - самый быстрый и наиболее эффективный среди трех, ввиду меньших затрат по использовании памяти